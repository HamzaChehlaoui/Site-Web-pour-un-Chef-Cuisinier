...
<body class="bg-gray-100 text-right font-sans">
    ...
    <header class="bg-black text-white py-4">
        <div class="container mx-auto text-center">
            ...
            <div class="mt-4">
                ...
                <button class="bg-black text-white py-2 px-6 rounded-lg hover:bg-gray-800">Delete Menu</button>
                <a href="reservation.php"><button class="bg-black text-white py-2 px-6 rounded-lg hover:bg-gray-800 mr-4">Reservation</button></a>
    ...
    <section class="py-8">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <!-- Repeat for Dish 2 and Dish 3 -->
                <!-- Dish 2 and 3 follow the same structure -->
            </div>
        </div>
    </section>

    <!-- Floating Plus Button -->
    <div tabindex="0" class="plusButton m-auto mt-10">
    ...
    <!-- Menu Section 2 (Repeat similar structure as Menu 1) -->
    <section class="py-8">
        <div class="container mx-auto px-4">
