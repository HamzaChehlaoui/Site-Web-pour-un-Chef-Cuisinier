...
<body class="bg-black text-white font-sans">
    ...
    <header class="bg-black text-white py-4">
        <div class="container mx-auto text-center">
            <h1 class="text-3xl font-bold text-yellow-500">Add a New Dish</h1>
        </div>
    </header>
    ...
    <section class="py-8">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-semibold mb-6 text-center text-yellow-500">Enter Dish Details</h2>
            <div class="max-w-lg mx-auto bg-gray-800 p-6 rounded-lg shadow-lg">
                <form action="addDishProcess.php" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-center mt-6">
                        <button type="submit" class="bg-yellow-500 text-black px-8 py-3 rounded-lg hover:bg-yellow-400 transition">Add Dish</button>
                    </div>
                </form>
            </div>
        </div>
