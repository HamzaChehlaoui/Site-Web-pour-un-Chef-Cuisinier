...
<body class="bg-black font-sans">
    ...
    <header class="bg-black text-white p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <h1 class="text-3xl font-bold ">Réservation Culinaire</h1>
            <nav class="space-x-6">
                <a href="#menus" class="hover:text-gray-300 text-3xl font-bold">Menus</a>
                <a href="#reservations" class="hover:text-gray-300 text-3xl font-bold">Réservations</a>
            </nav>
        </div>
    </header>
