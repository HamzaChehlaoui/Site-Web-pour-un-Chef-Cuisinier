...
<body class="bg-black text-white font-sans">
    ...
    <!-- Header -->
    <header class="bg-yellow-500 text-black py-4 text-center shadow-md">
        <h1 class="text-3xl font-extrabold tracking-wide txet-yellow-500">Gestion des Réservations</h1>
    </header>
