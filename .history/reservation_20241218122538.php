...
<body class="bg-black font-sans text-white">
    ...
    <!-- Header -->
    <header class="bg-yellow-600 text-black py-4 text-center">
    ...
    <main class="container mx-auto my-8 px-4">
        <div class="bg-white shadow-lg rounded-lg p-6">
            <h2 class="text-2xl font-semibold text-black mb-4">Demandes de Réservation</h2>
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center bg-gray-100 p-4 rounded-lg">
                    ...
                    <div class="flex space-x-4">
                        <button class="bg-yellow-500 text-black py-2 px-4 rounded-lg hover:bg-yellow-600 focus:outline-none">
                            Accepter
                        </button>
                        <button class="bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 focus:outline-none">
                            Refuser
                        </button>
                    </div>
                </div>
