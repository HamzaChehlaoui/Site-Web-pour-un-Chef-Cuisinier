...
<body class="bg-gray-100 text-right font-sans">
    ...
    <header class="bg-black text-white py-4">
        <div class="container mx-auto text-center">
            <h1 class="text-3xl font-bold">Welcome to Chef Cousin Restaurant</h1>
            <p class="text-xl mt-2">Cooking is the language of Chef, blending flavors and creativity</p>
